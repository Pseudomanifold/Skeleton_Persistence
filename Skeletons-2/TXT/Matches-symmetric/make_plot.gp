do for [t = 2:84] {
  ...
  plot in_forward  using 1:2 with points lc rgb PREVIOUS lw 1 pt 7 title "Previous",\
       in_backward using 1:2 with points lc rgb CURRENT lw 1 pt 7 title "Current",\
